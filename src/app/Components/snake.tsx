  ...
  return (
    <Suspense
      ...
      <div
        ...
        className="flex items-center justify-center h-full px-4 py-8 md:py-0 bg-cover bg-center bg-no-repeat " onKeyDown={handleKeyPress} tabIndex={0} onClick={handleToggleGame}
        onTouchStart={handleTouchStart}
        onTouchEnd={handleTouchEnd} autoFocus>
        {/* <CongratsMod al isOpen={isOpen} setIsOpen={setIsOpen} score={score} /> */}

        {/* Game Rules */}
        <div className=" h-full w-full flex-col flex justify-center  md:flex-row gap-0 md:gap-10 items-center" >
          ...
          <div className=" flex flex-col">
            ...
            <div className="relative w-fit h-full max-w-[90vw]  flex flex-col items-center border-4 p-1 sm:p-6 bg-black ">
              {gameOver && (
